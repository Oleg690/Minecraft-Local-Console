...
import os, cgi, json, sqlite3, psutil, datetime, time, jsonify
...
def start_clock():
    ...
    return {"message": "Clock started", "start_time": start_time}
...
def get_clock_time():
    ...
    if start_time:
        ...
        return {"message": "Clock not started yet"}
...
def main():
    ...
    if get_clock_time()['message'] == 'Clock not started yet':
